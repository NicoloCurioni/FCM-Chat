...
class ChatViewController: JSQMessagesViewController {
    //the local property to store messages.
    //It’s an array, and you need it to display chat messages
...
//        senderDisplayName = "Prashant"
        ...
        //Observing chnages in firebase database
